...
const Hero = () => {
  return (
    <AnimatedGridBackgroundSection>
      ...
      >
        <SparklesText
          text="Créer du contenu engageant avec l'IA "
          sparklesCount={6}
        />
      </div>
      ...
      <div className="md:text-xl text-lg text-center max-w-4xl mx-auto text-neutral-500 dark:text-neutral-400 leading-relaxed backdrop-blur-md">
        Ne perdez plus le tempsa savoir cquoi dire
      </div>
      <div className="flex justify-center items-center gap-4 mt-8">
        <Button>
          <Link href="/sign-in">Rejoindre l'aventure</Link>
        </Button>

        <Link href="/dashboard">
          <motion.button className="bg-teal-600 text-white px-6 py-2 rounded-full">
            Dashboard
          </motion.button>
        </Link>
      </div>
