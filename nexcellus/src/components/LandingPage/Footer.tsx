        ...
        <div>
          ...
          <div className="flex gap-4 sm:justify-end justify-center items-center">
            <Link
              ...
              className="underline ml-2"
            >
              <GithubIcon className="size-5 hover:scale-110 transition-transform duration-300" />
            </Link>
            ...
            <Link
              ...
              className="underline ml-2"
            >
              <TwitterIcon className="size-5 hover:scale-110 transition-transform duration-300" />
            </Link>
            ...
            <Link
              ...
              className="underline ml-2"
            >
              <LinkedinIcon className="size-5 hover:scale-110 transition-transform duration-300" />
            </Link>
          </div>
        </div>
      </div>
