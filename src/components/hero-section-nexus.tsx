...
const DigitalAgencyHero: React.FC = () => {
    ...
    return (
        <div className="pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
            ...
            <div className="absolute inset-0 z-1 pointer-events-none" style={{
                background: 'linear-gradient(to bottom, transparent 0%, rgb(0, 0, 0) 90%), radial-gradient(circle at 50% 0%, rgba(59, 130, 246, 0.15), transparent 70%)'
            }}></div>

            <Navbar isScrolled={isScrolled} />

            <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
                {/* Badge "Nous sommes une agence digitale" */}
                <motion.div
                ...
                >
                    <ShinyText
                        text="🚀 Agence de Communication Digitale"
                        className="bg-[#1a1a1a] border border-gray-700 text-[#3B82F6] px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-[#3B82F6]/50 transition-colors"
                    />
                </motion.div>
                ...
                >
                    ...
                    <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                        <RotatingText
                            ...
                            mainClassName="text-[#3B82F6] mx-1"
                            staggerFrom="last"
                            staggerDuration={0.01}
                ...
                >
                    ...
                    grâce à notre expertise en communication et marketing digital
                </motion.p>
                ...
                >
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 bg-[#3B82F6] text-white rounded-lg font-medium hover:bg-opacity-90 transition-all shadow-lg hover:shadow-[#3B82F6]/20"
                    >
                    ...
                    <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 border border-[#3B82F6] text-[#3B82F6] rounded-lg font-medium hover:bg-[#3B82F6]/10 transition-all"
                    >
                ...
                >
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-6 text-gray-400">
                        {/* Ajoutez ici vos logos partenaires */}
                        <div className="opacity-70 hover:opacity-100 transition-opacity">Logo 1</div>
                        <div className="opacity-70 hover:opacity-100 transition-opacity">Logo 2</div>
                        <div className="opacity-70 hover:opacity-100 transition-opacity">Logo 3</div>
                        <div className="opacity-70 hover:opacity-100 transition-opacity">Logo 4</div>
                    </div>
                </motion.div>
            </main>
        </div>
