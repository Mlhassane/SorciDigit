    ...
    >
      ...
      <div className="container mx-auto px-4 2xl:max-w-[1400px]">
        ...
        <div className="mx-auto mt-5 max-w-3xl text-center">
          ...
          <motion.div
            className={cn(
              'from-foreground/60 via-foreground to-foreground/60 dark:from-muted-foreground/55 dark:via-foreground dark:to-muted-foreground/55 max-w-5xl bg-gradient-to-r bg-clip-text text-center text-6xl text-transparent sm:text-6xl xl:text-6xl/none serif',
            )}
